...
class Cron_cemput1 extends CI_Controller {
public function __construct()
	...
	public function crawler_cemput1($codeuker, $pembina, $post){
		$ch = curl_init();
	...
	public function tuban()
	{
		...
		$pembina 	= "KABAG ITM";
		$post = [
		    'cpc' => 'BG TUBAN KOLABORASI',
		];

		$this->crawler_cemput1($codeuker, $pembina, $post);
	}
	public function ternate()
	{
		$codeuker = "74";
		$pembina 	= "KABAG RDI";
		$post = [
		    'cpc' => 'BG TERNATE KOLABORASI',
		];
	...
	public function kuantan()
	{
		...
		$pembina 	= "KABAG RDI";
		$post = [
		    'cpc' => 'BG TELUK KUANTAN KOLABORASI',
		];

		$this->crawler_cemput1($codeuker, $pembina, $post);
	}
	public function tj_pinang()
	{
		$codeuker = "88";
		$pembina 	= "KABAG RDI";
		$post = [
		    'cpc' => 'BG TANJUNG PINANG KOLABORASI',
		];

		$this->crawler_cemput1($codeuker, $pembina, $post);
	}

	public function tj_balai()
	{
		$codeuker = "124";
		$pembina 	= "KABAG ADE";
		$post = [
		    'cpc' => 'BG TANJUNG BALAI KOLABORASI',
		];

		$this->crawler_cemput1($codeuker, $pembina, $post);
	}

	public function bl_karimun()
	{
		$codeuker = "102";
		$pembina 	= "KABAG SPH";
		$post = [
		    'cpc' => 'BG TANJUNG BALAI KARIMUN KOLABORASI',
		];
	...
	public function soa()
	{
		...
		$pembina 	= "KABAG ADE";
		$post = [
		    'cpc' => 'BG SOA SIO KOLABORASI',
		];

		$this->crawler_cemput1($codeuker, $pembina, $post);
	}

	public function sidikalang()
	{
		$codeuker = "122";
		$pembina 	= "KABAG CPC";
		$post = [
		    'cpc' => 'BG SIDIKALANG KOLABORASI',
		];

		$this->crawler_cemput1($codeuker, $pembina, $post);
	}

	public function sibuhuan()
	{
		$codeuker = "114";
		$pembina	= "KABAG ITM";
		$post = [
		    'cpc' => 'BG SIBUHUAN KOLABORASI',
		];
	...
	public function panjang()
	{
		...
		$pembina	= "KABAG RDI";
		$post = [
		    'cpc' => 'BG SELAT PANJANG KOLABORASI',
		];

		$this->crawler_cemput1($codeuker, $pembina, $post);
	}

	public function sarolangun()
	{
		$codeuker = "113";
		$pembina 	= "KABAG RDI";
		$post = [
		    'cpc' => 'BG SAROLANGUN KOLABORASI',
		];

		$this->crawler_cemput1($codeuker, $pembina, $post);
	}

	public function sangatta()
	{
		$codeuker = "77";
		$pembina 	= "KABAG LND";
		$post = [
		    'cpc' => 'BG SANGATTA KOLABORASI',
		];
	...
	public function sampit()
	{
		...
		$pembina 	= "KABAG SPH";
		$post = [
		    'cpc' => 'BG SAMPIT KOLABORASI',
		];

		$this->crawler_cemput1($codeuker, $pembina, $post);
	}

	public function bujang()
	{
		$codeuker = "118";
		$pembina	= "KABAG DSP";
		$post = [
		    'cpc' => 'BG RIMBO BUJANG KOLABORASI',
		];
